...
void Menu_Cache( void )
{
...
#else
	uis.charsetShaders[0] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar0");
	uis.charsetShaders[1] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar1");
	uis.charsetShaders[2] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar2");
	uis.charsetShaders[3] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar3");
	uis.charsetShaders[4] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar4");
	uis.charsetShaders[5] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar5");
	uis.charsetShaders[6] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar6");
	uis.charsetShaders[7] = trap_R_RegisterShaderNoMip("gfx/2d/bigchar7");
#endif
	...
	/*
	uis.cursorCore1		= trap_R_RegisterShaderNoMip("bfgCore1");	// JUHOX
	uis.cursorCore2		= trap_R_RegisterShaderNoMip("bfgCore2");	// JUHOX
	uis.cursorCore3		= trap_R_RegisterShaderNoMip("bfgCore3");	// JUHOX
	*/
	uis.lfRing			= trap_R_RegisterShaderNoMip("bfgLFRing");	// JUHOX
	uis.lfDisc			= trap_R_RegisterShaderNoMip("bfgLFDisc");	// JUHOX
	uis.lfGlare			= trap_R_RegisterShaderNoMip("bfgLFGlare");	// JUHOX
	uis.lfStar			= trap_R_RegisterShaderNoMip("bfgLFStar");	// JUHOX
	uis.whiteShader = trap_R_RegisterShaderNoMip( "white" );
	// JUHOX: use the hunt background picture
#if 0
...
#else
	if (uis.glconfig.maxTextureSize <= 256) {
		uis.menuBackShader = trap_R_RegisterShaderNoMip("gfx/hunt_back256.tga");
	}
	else if (uis.glconfig.maxTextureSize <= 512 || !ui_hiDetailTitle.integer) {
		uis.menuBackShader = trap_R_RegisterShaderNoMip("gfx/hunt_back512.tga");
	}
	else {
		uis.menuBackShader = trap_R_RegisterShaderNoMip("gfx/hunt_back1024.tga");
	}
	uis.menuBackTitleShader = trap_R_RegisterShaderNoMip("gfx/hunt_name.tga");
#endif
