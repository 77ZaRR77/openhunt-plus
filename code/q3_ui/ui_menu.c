...
void UI_MainMenu( void ) {
	...
	y = 134;
	y -= 1.5 * MAIN_MENU_VERTICAL_SPACING;	// JUHOX
	s_main.singleplayer.generic.type		= MTYPE_PTEXT;
	s_main.singleplayer.generic.flags		= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
	...
	s_main.multiplayer.generic.flags		= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
	...
	s_main.setup.generic.flags				= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
	...
	s_main.demos.generic.flags				= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
	...
	s_main.mods.generic.flags			= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
	...
	s_main.exit.generic.flags				= /*QMF_CENTER_JUSTIFY*/QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;	// JUHOX
