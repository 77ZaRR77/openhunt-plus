...
static const char *servertype_items[] = {	// JUHOX NOTE: index is GAMES_xxx
	"All",
	"Free For All",
	"Team Deathmatch",
	"Tournament",
...
static char* gamenames[] = {	// JUHOX NOTE: index is GT_xxx
	"DM ",	// deathmatch
	"1v1",	// tournament
	"SP ",	// single player
...
static void ArenaServers_Event( void* ptr, int event ) {
	...
	case ID_CREATE:
#if 0	// JUHOX: start with game type selection menu
