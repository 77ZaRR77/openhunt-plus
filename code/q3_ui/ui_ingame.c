...
void InGame_MenuInit( void ) {
	...
	s_ingame.gametemplates.generic.x		= 320;
	s_ingame.gametemplates.generic.y		= y;
	s_ingame.gametemplates.generic.id		= ID_GAMETEMPLATES;
	s_ingame.gametemplates.generic.callback	= InGame_Event;
