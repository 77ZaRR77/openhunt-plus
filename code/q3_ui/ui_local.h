...
#define NUM_WEAPONORDERS 6	// JUHOX: should match the #define in cg_local.h
...
#define MAX_MENUITEMS			96	// JUHOX: was 64
...
typedef struct _tag_menuframework
{
	...
	qboolean	fullscreen;
	qboolean	showlogo;
	qboolean	blackBack;	// JUHOX
	qboolean	noCursor;	// JUHOX
} menuframework_s;
...
extern void UI_Hunt_Credits(void);	// JUHOX
...
extern void UI_PlayerModelMenu(
	...
	const char* modelcvar1Name,
	const char* modelcvar2Name,
	const char* modelcvar3Name,
	const char* modelcvar4Name,
	char* modelBuffer,
	int modelBufferSize,
	weapon_t weapon
);
...
extern void UI_TemplateMenu(qboolean inGame, qboolean multiplayer);	// JUHOX
extern void UI_TemplateList_SvTemplate(	// JUHOX
	int n, const char* name, int highscoreType, const char* highscore, const char* descriptor
);
extern void UI_TemplateList_Complete(int number, long checksum);	// JUHOX
extern void UI_GTS_Menu(qboolean multiplayer);	// JUHOX
