...
#ifndef NULL
#define NULL 0/*((void *)0)*/	// JUHOX: prevent warnings
#endif
...
// JUHOX: use lrand() for random() macro
#if 0
#define random()	((rand () & 0x7fff) / ((float)0x7fff))
#else
unsigned long lrand(void);
#define random()	(lrand()/4294967295.0)
#endif
...
#define MAX_LOCATIONS		/*64*/100	// JUHOX BUGFIX: it seems, some maps exceeded the old limit
...
#define BUTTON_HOLD_BREATH	4096		// JUHOX
