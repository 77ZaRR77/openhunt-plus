...
void SP_trigger_push( gentity_t *self ) {
	InitTrigger (self);
	self->r.contents |= CONTENTS_JUMPPAD;	// JUHOX: to make life easier for the "grenades using jumppads" feature
...
void SP_trigger_teleport( gentity_t *self ) {
	InitTrigger (self);
	self->r.contents |= CONTENTS_TELEPORTER;	// JUHOX: to make life easier for the "missiles using teleporters" feature
