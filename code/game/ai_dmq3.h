...
void BotFindCTFBases(void);	// JUHOX
void BotCreateItemGoal(gentity_t* ent, bot_goal_t* goal);	// JUHOX
qboolean BotEnemyTooStrong(bot_state_t* bs);	// JUHOX
qboolean LTGNearlyFulfilled(bot_state_t* bs);	// JUHOX
...
qboolean BotArmorIsUsefulForPlayer(const playerState_t* ps);	// JUHOX
qboolean BotLimitedHealthIsUsefulForPlayer(const playerState_t* ps);	// JUHOX
qboolean BotUnlimitedHealthIsUsefulForPlayer(const playerState_t* ps);	// JUHOX
qboolean BotHoldableItemIsUsefulForPlayer(const playerState_t* ps);	// JUHOX
int BotPlayerKillDamage(const playerState_t* ps);	// JUHOX
int BotPlayerDanger(const playerState_t* ps);	// JUHOX
//choose a weapon
...
#define VIEWER_SAMETEAM -1		// JUHOX
#define VIEWER_OTHERTEAM -2		// JUHOX
qboolean EntityIsInvisible(int viewer, aas_entityinfo_t *entinfo);	// JUHOX: added 'viewer'
...
int BotWantsToEscape(bot_state_t* bs);	// JUHOX
