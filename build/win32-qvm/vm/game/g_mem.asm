...
;9:
;10:
;11:// JUHOX: increased memory pool size
;12:#if 0
;13:#define POOLSIZE	(256 * 1024)
;14:#else
;15:#define POOLSIZE	(512 * 1024)
;16:#endif
;17:
;18:static char		memoryPool[POOLSIZE];
;19:static int		allocPoint;
;20:
;21:void *G_Alloc( int size ) {
line 24
;22:	char	*p;
;23:
;24:	if ( g_debugAlloc.integer ) {
ADDRGP4 g_debugAlloc+12
INDIRI4
CNSTI4 0
EQI4 $88
line 25
;25:		G_Printf( "G_Alloc of %i bytes (%i left)\n", size, POOLSIZE - allocPoint - ( ( size + 31 ) & ~31 ) );
ADDRGP4 $91
ARGP4
ADDRLP4 4
ADDRFP4 0
...
line 28
;27:
;28:	if ( allocPoint + size > POOLSIZE ) {
ADDRGP4 allocPoint
INDIRI4
ADDRFP4 0
INDIRI4
...
LEI4 $92
line 29
;29:	  G_Error( "G_Alloc: failed on allocation of %i bytes\n", size ); // bk010103 - was %u, but is signed
ADDRGP4 $94
ARGP4
ADDRFP4 0
INDIRI4
...
line 44
;43:
;44:void Svcmd_GameMem_f( void ) {
line 45
;45:	G_Printf( "Game memory status: %i out of %i bytes allocated\n", allocPoint, POOLSIZE );
ADDRGP4 $97
ARGP4
ADDRGP4 allocPoint
INDIRI4
