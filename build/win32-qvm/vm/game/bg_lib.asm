...
;195:
;196:// bk001211 - gcc errors on compiling strcpy:  parse error before `__extension__'
;197:#if defined ( Q3_VM )
;198:
;199:size_t strlen( const char *string ) {
line 202
;200:	const char	*s;
;201:
;202:	s = string;
...
;208:
;209:
;210:char *strcat( char *strDestination, const char *strSource ) {
line 213
;211:	char	*s;
;212:
;213:	s = strDestination;
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
;222:}
;223:
;224:char *strcpy( char *strDestination, const char *strSource ) {
line 227
;225:	char *s;
;226:
...
;234:
;235:
;236:int strcmp( const char *string1, const char *string2 ) {
ADDRGP4 $143
JUMPV
LABELV $142
line 237
;237:	while ( *string1 == *string2 && *string1 && *string2 ) {
line 238
;238:		string1++;
ADDRFP4 0
ADDRFP4 0
...
;243:
;244:
;245:char *strchr( const char *string, int c ) {
ADDRGP4 $149
JUMPV
LABELV $148
line 246
...
;253:}
;254:
;255:char *strstr( const char *string, const char *strCharSet ) {
ADDRGP4 $155
JUMPV
LABELV $154
line 256
...
;271:#endif // bk001211
;272:
;273:// bk001120 - presumably needed for Mac
;274://#if !defined(_MSC_VER) && !defined(__linux__)
;275:// bk001127 - undid undo
;276:#if defined ( Q3_VM )
;277:
...
;770:
;771:
;772:#if 0	// JUHOX: use a more random algorithm for rand()
;773:static int randSeed = 0;
;774:
;775:void	srand( unsigned seed ) {
;776:	randSeed = seed;
;777:}
;778:
;779:int		rand( void ) {
;780:	randSeed = (69069 * randSeed + 1);
;781:	return randSeed & 0x7fff;
;782:}
;783:#else
;784:static unsigned long randSeed[4] = {0, 0, 0, 0};
;785:
;786:void srand(unsigned int seed) {
line 787
;787:	randSeed[0] = 0;
ADDRGP4 randSeed
CNSTU4 0
...
line 798
;797:
;798:	r += 0x185d9e6d * (randSeed[0] ^ 0xc7b347cf);
ADDRLP4 0
ADDRLP4 0
INDIRU4
ADDRGP4 randSeed
...
line 801
;800:
;801:	r += 0x019e7f31 * (randSeed[1] ^ 0x37cacc44);
ADDRLP4 0
ADDRLP4 0
INDIRU4
ADDRGP4 randSeed+4
...
line 804
;803:
;804:	r += 0xe724da75 * (randSeed[2] ^ 0xc37bd473);
ADDRLP4 0
ADDRLP4 0
INDIRU4
ADDRGP4 randSeed+8
...
line 807
;806:
;807:	r += 0xd61ca29d * (randSeed[3] ^ 0x1dc1b026);
ADDRLP4 0
ADDRLP4 0
INDIRU4
ADDRGP4 randSeed+12
...
;817:#endif
;818:
;819:double atof( const char *string ) {
ADDRGP4 $200
JUMPV
LABELV $199
line 826
...
line 883
;880:
;881:	// not handling 10e10 notation...
;882:
;883:	return value * sign;
ADDRLP4 4
INDIRF4
ADDRLP4 8
INDIRF4
...
;884:}
;885:
;886:double _atof( const char **stringPtr ) {
line 890
;887:	const char	*string;
;888:	float sign;
;889:	float value;
;890:	int		c = '0'; // bk001211 - uninitialized use possible
ADDRLP4 0
CNSTI4 48
ASGNI4
line 892
;891:
;892:	string = *stringPtr;
ADDRLP4 4
ADDRFP4 0
INDIRP4
INDIRP4
...
line 949
;947:
;948:	// not handling 10e10 notation...
;949:	*stringPtr = string;
ADDRFP4 0
INDIRP4
ADDRLP4 4
INDIRP4
...
;953:
;954:
;955:// bk001120 - presumably needed for Mac
;956://#if !defined ( _MSC_VER ) && ! defined ( __linux__ )
;957:
;958:// bk001127 - undid undo
;959:#if defined ( Q3_VM )
;960:int atoi( const char *string ) {
ADDRGP4 $254
JUMPV
LABELV $253
line 967
...
line 1002
;999:
;1000:	// not handling 10e10 notation...
;1001:
;1002:	return value * sign;
ADDRLP4 4
INDIRI4
ADDRLP4 8
INDIRI4
...
;1004:
;1005:
;1006:int _atoi( const char **stringPtr ) {
line 1012
;1007:	int		sign;
;1008:	int		value;
;1009:	int		c;
...
line 1050
;1047:
;1048:	// not handling 10e10 notation...
;1049:
;1050:	*stringPtr = string;
ADDRFP4 0
INDIRP4
ADDRLP4 4
INDIRP4
...
;1066:
;1067:
;1068:#define ALT			0x00000001		/* alternate form */
;1069:#define HEXPREFIX	0x00000002		/* add 0x or 0X prefix */
;1070:#define LADJUST		0x00000004		/* left adjustment */
;1071:#define LONGDBL		0x00000008		/* long double */
;1072:#define LONGINT		0x00000010		/* long integer */
;1073:#define QUADINT		0x00000020		/* quad integer */
;1074:#define SHORTINT	0x00000040		/* short integer */
;1075:#define ZEROPAD		0x00000080		/* zero (as opposed to blank) pad */
;1076:#define FPT			0x00000100		/* floating point number */
;1077:
;1078:#define to_digit(c)		((c) - '0')
;1079:#define is_digit(c)		((unsigned)to_digit(c) <= 9)
;1080:#define to_char(n)		((n) + '0')
;1081:
;1082:void AddInt( char **buf_p, int val, int width, int flags ) {
line 1088
;1083:	char	text[32];
;1084:	int		digits;
;1085:	int		signedVal;
...
LABELV $304
line 1105
;1105:		while ( digits < width ) {
line 1106
;1106:			*buf++ = ( flags & ZEROPAD ) ? '0' : ' ';
ADDRLP4 48
ADDRLP4 4
INDIRP4
ASGNP4
...
line 1125
;1124:
;1125:void AddFloat( char **buf_p, float fval, int width, int prec ) {
line 1133
;1126:	char	text[32];
;1127:	int		digits;
;1128:	float	signedVal;
;1129:	char	*buf;
;1130:	int		val;
;1131:
;1132:	// get the sign
...
ASGNF4
line 1171
;1170:#if 1	// JUHOX: round the least significant digit
;1171:		if (digits == prec-1) fval += 0.5;
ADDRLP4 0
INDIRI4
ADDRFP4 12
INDIRI4
...
line 1178
;1176:
;1177:#if 1	// JUHOX: delete non significant zero digits
;1178:	while (digits > 0 && text[digits-1] == '0') digits--;
ADDRLP4 0
ADDRLP4 0
INDIRI4
CNSTI4 1
...
ASGNI1
line 1184
;1184:		for (prec = 0; prec < digits; prec++) {
ADDRFP4 12
CNSTI4 0
ASGNI4
ADDRGP4 $352
...
;1189:}
LABELV $321
endproc AddFloat 64 0
export AddString
proc AddString 16 4
line 1192
;1190:
;1191:
;1192:void AddString( char **buf_p, char *string, int width, int prec ) {
line 1196
;1193:	int		size;
;1194:	char	*buf;
;1195:
...
LTI4 $357
line 1204
;1204:		for( size = 0; size < prec; size++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $362
...
;1228:vsprintf
;1229:
;1230:I'm not going to support a bunch of the more arcane stuff in here
;1231:just to keep it simpler.  For example, the '*' and '$' are not
;1232:currently supported.  I've tried to make it so that it will just
;1233:parse and ignore formats we don't support.
;1234:*/
;1235:int vsprintf( char *buffer, const char *fmt, va_list argptr ) {
line 1245
;1236:	int		*arg;
;1237:	char	*buf_p;
;1238:	char	ch;
...
;1248:	while( qtrue ) {
line 1250
;1249:		// run through the format string until we hit a '%' or '\0'
;1250:		for ( ch = *fmt; (ch = *fmt) != '\0' && ch != '%'; fmt++ ) {
ADDRLP4 0
ADDRFP4 4
INDIRP4
INDIRI1
...
;1303:		case 'd':
;1304:		case 'i':
;1305:			AddInt( &buf_p, *arg, width, flags );
ADDRLP4 4
ARGP4
ADDRLP4 24
INDIRP4
...
line 1309
;1308:		case 'f':
;1309:			AddFloat( &buf_p, *(double *)arg, width, prec );
ADDRLP4 4
ARGP4
ADDRLP4 24
INDIRP4
...
line 1311
;1310:#ifdef __LCC__
;1311:			arg += 1;	// everything is 32 bit in my compiler
ADDRLP4 24
ADDRLP4 24
INDIRP4
CNSTI4 4
...
line 1317
;1316:		case 's':
;1317:			AddString( &buf_p, (char *)*arg, width, prec );
ADDRLP4 4
ARGP4
ADDRLP4 24
INDIRP4
...
;1334:
;1335:
;1336:/* this is really crappy */
;1337:int sscanf( const char *buffer, const char *fmt, ... ) {
line 1342
;1338:	int		cmd;
;1339:	int		**arg;
;1340:	int		count;
